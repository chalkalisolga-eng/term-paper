...
# Ітератор за порою року (вимога Варіанта 20)
...
class MeteoStation:
    ...
    def save_system_state(self, filepath="meteo_backup.pkl"):
        ...
        print("[System] 💾 Стан системи (об'єкти агрегації) законсервовано (pickle).")
    ...
    def import_from_csv(self, filepath="test_weather.csv"):
        try:
            with open(filepath, 'r', encoding='utf-8') as f:
                ...
                count = 0
                for row in reader:
                    # Формат: YYYY-MM-DD, temp, RAIN/SNOW/CLEAR
            ...
            print(f"[System] ⚠️ Файл {filepath} не знайдено для імпорту.")
